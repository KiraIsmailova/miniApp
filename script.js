...
const count = document.querySelector('.form-user-count')
const countInput = count.input

count.addEventListener('submit', event => {
    event.preventDefault()

    getData(countInput.value)
})
    ...
    for (let user of list) {
        ...
        const html = `<img class="rounded user-img" src="${user.picture.large}" alt="">
                ...
                block.addEventListener("click", () => {
                  ...
                  const modalContent = userModal.querySelector(".modal-body");
                  const userModalTitle = userModal.querySelector(".modal-title");
